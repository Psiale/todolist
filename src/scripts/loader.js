import * as newListObject from './domManipulation';
...
const load = () => {
  ...
  mainContainer.append(newListObject.projectGenerator(), newListObject.todoItemGenerator(), newListObject.todoListTasks());
